...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195855485177863063)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195855766389863063)
,p_plug_template_id=>wwv_flow_imp.id(25195855485177863063)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195856066788863063)
,p_plug_template_id=>wwv_flow_imp.id(25195855485177863063)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195856356724863063)
,p_plug_template_id=>wwv_flow_imp.id(25195855485177863063)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195856609541863063)
,p_plug_template_id=>wwv_flow_imp.id(25195855485177863063)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195856984815863063)
,p_plug_template_id=>wwv_flow_imp.id(25195855485177863063)
,p_name=>'Sub Regions'
