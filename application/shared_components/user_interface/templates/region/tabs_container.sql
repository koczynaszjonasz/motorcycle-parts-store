...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195875163736863072)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195875485371863072)
,p_plug_template_id=>wwv_flow_imp.id(25195875163736863072)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195875740538863073)
,p_plug_template_id=>wwv_flow_imp.id(25195875163736863072)
,p_name=>'Tabs'
