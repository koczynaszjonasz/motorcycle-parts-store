...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195882570540863075)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195882822872863076)
,p_plug_template_id=>wwv_flow_imp.id(25195882570540863075)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195883154867863076)
,p_plug_template_id=>wwv_flow_imp.id(25195882570540863075)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195883409502863076)
,p_plug_template_id=>wwv_flow_imp.id(25195882570540863075)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195883700935863076)
,p_plug_template_id=>wwv_flow_imp.id(25195882570540863075)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195884041646863076)
,p_plug_template_id=>wwv_flow_imp.id(25195882570540863075)
