...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195827693251863049)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195827959461863050)
,p_plug_template_id=>wwv_flow_imp.id(25195827693251863049)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195828270024863050)
,p_plug_template_id=>wwv_flow_imp.id(25195827693251863049)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195828562730863050)
,p_plug_template_id=>wwv_flow_imp.id(25195827693251863049)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195828823545863050)
,p_plug_template_id=>wwv_flow_imp.id(25195827693251863049)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195829105221863050)
,p_plug_template_id=>wwv_flow_imp.id(25195827693251863049)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195829447704863050)
,p_plug_template_id=>wwv_flow_imp.id(25195827693251863049)
,p_name=>'Sub Regions'
