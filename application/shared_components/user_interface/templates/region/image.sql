...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195835403000863053)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195835720620863054)
,p_plug_template_id=>wwv_flow_imp.id(25195835403000863053)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195836006629863054)
,p_plug_template_id=>wwv_flow_imp.id(25195835403000863053)
,p_name=>'Sub Regions'
