...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195399235107863035)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195399581805863036)
,p_plug_template_id=>wwv_flow_imp.id(25195399235107863035)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195399858724863036)
,p_plug_template_id=>wwv_flow_imp.id(25195399235107863035)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195800193970863036)
,p_plug_template_id=>wwv_flow_imp.id(25195399235107863035)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195800427605863036)
,p_plug_template_id=>wwv_flow_imp.id(25195399235107863035)
,p_name=>'Sub Regions'
