...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195857590773863064)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195857808728863064)
,p_plug_template_id=>wwv_flow_imp.id(25195857590773863064)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195858182006863064)
,p_plug_template_id=>wwv_flow_imp.id(25195857590773863064)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195858401737863064)
,p_plug_template_id=>wwv_flow_imp.id(25195857590773863064)
,p_name=>'Button Start'
