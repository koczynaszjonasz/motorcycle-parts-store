...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195800620268863036)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195800905507863036)
,p_plug_template_id=>wwv_flow_imp.id(25195800620268863036)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195801295596863037)
,p_plug_template_id=>wwv_flow_imp.id(25195800620268863036)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195801537097863037)
,p_plug_template_id=>wwv_flow_imp.id(25195800620268863036)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195801850191863037)
,p_plug_template_id=>wwv_flow_imp.id(25195800620268863036)
,p_name=>'Sub Regions'
