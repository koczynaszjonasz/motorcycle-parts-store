...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195862506435863066)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195862887596863066)
,p_plug_template_id=>wwv_flow_imp.id(25195862506435863066)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195863142995863066)
,p_plug_template_id=>wwv_flow_imp.id(25195862506435863066)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195863474290863067)
,p_plug_template_id=>wwv_flow_imp.id(25195862506435863066)
,p_name=>'Sub Regions'
