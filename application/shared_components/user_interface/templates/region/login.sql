...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195860095613863065)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195860348101863065)
,p_plug_template_id=>wwv_flow_imp.id(25195860095613863065)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195860600820863065)
,p_plug_template_id=>wwv_flow_imp.id(25195860095613863065)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195860974450863065)
,p_plug_template_id=>wwv_flow_imp.id(25195860095613863065)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195861262795863065)
,p_plug_template_id=>wwv_flow_imp.id(25195860095613863065)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195861549142863065)
,p_plug_template_id=>wwv_flow_imp.id(25195860095613863065)
,p_name=>'Sub Regions'
