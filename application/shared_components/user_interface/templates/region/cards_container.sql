...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195806356046863040)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195806638632863040)
,p_plug_template_id=>wwv_flow_imp.id(25195806356046863040)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195806972102863040)
,p_plug_template_id=>wwv_flow_imp.id(25195806356046863040)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195807230934863040)
,p_plug_template_id=>wwv_flow_imp.id(25195806356046863040)
,p_name=>'Sub Regions'
