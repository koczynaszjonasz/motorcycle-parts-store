...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195832242826863052)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195832544734863052)
,p_plug_template_id=>wwv_flow_imp.id(25195832242826863052)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195832860383863052)
,p_plug_template_id=>wwv_flow_imp.id(25195832242826863052)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195833144592863052)
,p_plug_template_id=>wwv_flow_imp.id(25195832242826863052)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195833401739863052)
,p_plug_template_id=>wwv_flow_imp.id(25195832242826863052)
,p_name=>'Sub Regions'
