...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25195850035789863061)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195850354262863061)
,p_plug_template_id=>wwv_flow_imp.id(25195850035789863061)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195850665877863061)
,p_plug_template_id=>wwv_flow_imp.id(25195850035789863061)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195850924029863061)
,p_plug_template_id=>wwv_flow_imp.id(25195850035789863061)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195851228670863061)
,p_plug_template_id=>wwv_flow_imp.id(25195850035789863061)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195851541212863061)
,p_plug_template_id=>wwv_flow_imp.id(25195850035789863061)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195851839527863061)
,p_plug_template_id=>wwv_flow_imp.id(25195850035789863061)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195852167061863061)
,p_plug_template_id=>wwv_flow_imp.id(25195850035789863061)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195852470155863062)
,p_plug_template_id=>wwv_flow_imp.id(25195850035789863061)
,p_name=>'Sub Regions'
