...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(25195373332035863023)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195373626497863023)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195373983670863023)
,p_page_template_id=>wwv_flow_imp.id(25195373332035863023)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195374238898863023)
,p_page_template_id=>wwv_flow_imp.id(25195373332035863023)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195374598068863023)
,p_page_template_id=>wwv_flow_imp.id(25195373332035863023)
,p_name=>'Body Footer'
