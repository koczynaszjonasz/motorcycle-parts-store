...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(25195383930869863028)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195384262221863028)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195384541370863028)
,p_page_template_id=>wwv_flow_imp.id(25195383930869863028)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195384839882863028)
,p_page_template_id=>wwv_flow_imp.id(25195383930869863028)
