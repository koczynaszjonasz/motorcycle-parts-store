...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(25195362742691863017)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195363009512863017)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195363350702863017)
,p_page_template_id=>wwv_flow_imp.id(25195362742691863017)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195363694978863017)
,p_page_template_id=>wwv_flow_imp.id(25195362742691863017)
