...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(25195392537464863032)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195392887538863032)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195393136863863032)
,p_page_template_id=>wwv_flow_imp.id(25195392537464863032)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25195393407077863033)
,p_page_template_id=>wwv_flow_imp.id(25195392537464863032)
